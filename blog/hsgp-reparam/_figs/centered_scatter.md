::: {#fig-centered_scatter}

![](_figs/centered_scatter.png)

**Dependency of centered basis function weights on GP hyperparameters**.
Posterior pair plots of select (numbers 1, 2, 19, and 20) **centered** basis function weights against the GP hyperparameters.
