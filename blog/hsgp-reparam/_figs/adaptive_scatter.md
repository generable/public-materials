::: {#fig-adaptive_scatter}

![](_figs/adaptive_scatter.png)

**Dependency of optimally resampled basis function weights on GP hyperparameters**.
Posterior pair plots of select (numbers 1, 2, 19, and 20) **optimally resampled** basis function weights against the GP hyperparameters.
All quantities are plotted such that they represent the sampler geometry.
Row-wise (from top to bottom): Different basis functions (numbers 1, 2, 19, and 20).
